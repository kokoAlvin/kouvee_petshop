<template>
    <div>
        <v-navigation-drawer v-model = "drawer" class = "grey darken-3" dark app clipped fixed temporary>
            <v-list-item>
                <v-list-item-content>
                    <v-list-item-title class="title">P3L Goliath</v-list-item-title>
        ...
        <v-app-bar dark app fixed clipped-left height="70px" color="grey darken-3">
            ...
            <v-toolbar-title style="font-size: 21px;" class="white--text ml-2">P3L-UAJY</v-toolbar-title>
        </v-app-bar>
...
export default {
    data(){
        return {
            drawer: null,
            items: [
                { title: 'Hewan Controller', icon: 'mdi-human-male', router:'/'},
            ],
        }
    },
}
