...
<v-container>
    ...
    <v-container grid-list-md mb-0>
        ...
        <template v-slot:body="{ items }" >
            ...
            <tr v-for="(item,index) in items" :key="item.id_customer">
                ...
                <td>{{ item.tanggal_lahir_customer }}</td>
                <td>{{ item.nomor_hp_customer }}</td>
    ...
    <v-card>
        ...
        <v-container>
            <v-row>
            <v-col cols="12">
                <v-text-field label="Nama_Customer*" v-model="form.nama_customer" required></v-text-field>
            </v-col>
            <v-col cols="12">
                <v-text-field label="Alamat_Customer*" v-model="form.alamat_customer" required></v-text-field>
            </v-col>
            <v-col cols="12">
                <v-text-field label="Tanggal_Lahir_Customer*" v-model="form.tanggal_lahir_customer"  required></v-text-field>
            </v-col>
            <v-col cols="12">
                <v-text-field label="Nomor_HP_Customer*" v-model="form.nomor_hp_customer"  required></v-text-field>
            </v-col>
            </v-row>
        </v-container>
...
data() {
    ...
    headers: [
        ...
        {
        text: 'Tanggal_Lahir_Customer',
        value: 'tanggal_lahir_customer'
        },
        {
        text: 'Nomor_HP_Customer',
        value: 'nomor_hp_customer'
        },
        {
        text: 'Created_Date',
        value: 'created_date',
...
methods: {
    ...
    this.customer.append('nomor_hp_customer', this.form.nomor_hp_customer);
    this.customer.append('created_date', this.form.created_date);
    this.customer.append('updated_date', this.form.updated_date);
    this.customer.append('deleted_date', this.form.deleted_date);
    ...
    this.form.nomor_hp_customer = item.nomor_hp_customer;
